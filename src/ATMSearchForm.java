...
//
//public class ATMSearchForm extends Application {
//
//    //    static {
////        try {
...
//
//    private static final String JDBC_URL = "jdbc:mysql:http//localhost:3306/atm_database";
...
//                    City branchCity = new City(resultSet.getString("city_name"), resultSet.getString("state"));
//
